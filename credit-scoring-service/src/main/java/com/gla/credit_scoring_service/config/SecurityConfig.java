// ════════════════════════════════════════════════════════════════════════════
// FILE: com/gla/credit_scoring_service/config/SecurityConfig.java
// ════════════════════════════════════════════════════════════════════════════
...
/**
 * Security configuration for credit-scoring-service (:8083).
 *
 * ROUTE RULES:
 *   /api/v1/credit/score        → USER or ADMIN (hasAnyRole)
 *   /api/v1/credit/admin/**     → ADMIN only
